...
w(6,1) = (1/56)*(-beta + sign(3/2 - K)*sqrt(beta*beta - 112*gamma));
w(5,1) = -3*w(6,1) - 1/16 + (K+r^2)/8 + ((3*K-1)*r)/12 + (r^3)/12;
w(4,1) = 2*w(6,1) + 1/4 + (4-3*K)*r/6 - r^3/6;
w(3,1) = 2*w(6,1) + 5/8 - (K+r^2)/4;
w(2,1) = -3*w(6,1) + 1/4 - (4-3*K)*r/6 + r^3/6;
w(1,1) = w(6,1) - 1/16 + (K+r^2)/8 - (3*K-1)*r/12 - r^3/12;
