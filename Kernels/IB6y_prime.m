...
w(6,1) = (1/56).*((-22/3)+7.*K+3.*r+7.*r.^2+(1/2).*(2.*((22/3)+(-7).*K+(-3) ...
...
w(5,1) = (11/28)+(-3/8).*K+(1/12).*((-1)+3.*K)+(5/56).*r+(-1/8).*r.^2+( ...
...
w(4,1) = (1/84).*(34+(-21).*K+9.*r+(-21).*r.^2+(-1).*((-1)+2.*r).*(198+ ...
...
w(3,1) = (1/336).*((-88)+84.*K+(-66).*r+28.*r.^2+2.*r.*((-33)+28.*r)+(-4).* ...
  ...
  -1/2));
w(2,1) = (11/28)+(-3/8).*K+(1/6).*((-4)+3.*K)+(-9/56).*r+(1/8).*r.^2+(1/56) ...
